...
export class GetArticleByIdRequest implements IGetArticleByIdRequest {
  ...
  public static create(
    properties?: IGetArticleByIdRequest
   ...
   */
  public static encode(
    message: IGetArticleByIdRequest,
    writer?: $protobuf.Writer
  ): $protobuf.Writer;
...
export class CreateArticleRequest implements ICreateArticleRequest {
   ...
   */
  public static create(
    properties?: ICreateArticleRequest
...
export class ArticleService extends $protobuf.rpc.Service {
  ...
  public getArticleById(
    request: IGetArticleByIdRequest,
    callback: ArticleService.GetArticleByIdCallback
  ): void;
  ...
  public createArticle(
    ...
    callback: ArticleService.CreateArticleCallback
  ): void;
